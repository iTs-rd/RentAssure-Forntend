                ...
                <div className="col-6  rowbox ">
                    <div className="text">
                        <div className="block1">
                            <h1>ABOUT US</h1>
                            <p>
                                Launched in 2021, <span className="word">Rent</span>Assure.com, India’s No. 1 property portal, deals with every aspect
                                of the consumers’ needs in the real estate industry. It is an online forum which provide a plateform to people who
                                rents property like house/room/flat from renter. At <span className="word">Rent</span>Assure.com, you can advertise a
                        ...
                        <div className="block2">
                            ...
                            <p>
                                At present, <span className="word">Rent</span> In addition to providing an online platform to real estate developers,
                                brokers and property owners for listing their property for sale, purchase or rent, <span className="word">Rent</span>
                                Assure.com offers advertisement stints such as microsites, banners, home page links and project pages to the clients
