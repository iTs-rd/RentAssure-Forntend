...
class EditUserProperty extends Component {
	constructor(props) {
		...
		if (!this.state.token) window.location.href = "/";
		...
		fetch(`${process.env.REACT_APP_API_URL}/api/data/${this.props.id}`, {
			...
			.then((res) => {
				this.setState({
					...
					parking: res.parking,
					lift: res.lift,
					swimming_pool: res.swimming_pool,
					gym: res.gym,
					gas_pipeline: res.gas_pipeline,
					electricity_charge: res.electricity_charge,
					electricity_supply: res.electricity_supply,
					Power_backup: res.Power_backup,
					water_charge: res.water_charge,
					water_supply: res.water_supply,
					water_purifier: res.water_purifier,
					fridge: res.fridge,
					washing_machine: res.washing_machine,
					CCTV: res.CCTV,
					guard: res.guard,
					medical: res.medical,
					fire_alarme: res.fire_alarme,
					cleaning: res.cleaning,
					furnished: res.furnished,
					available_for: res.available_for,
					available_from: res.available_from,
					rent: res.rent,
					additional_charge: res.additional_charge,
					security_money: res.security_money,
					one_time_charge: res.one_time_charge,
					agreement_duration: res.agreement_duration,
					owner_name: res.owner_name,
					owner_phone_no1: res.owner_phone_no1,
					owner_phone_no2: res.owner_phone_no2,
					posted_by: res.posted_by,
					posted_on: res.posted_on,
					agent_name: res.agent_name,
					age_of_property: res.age_of_property,
	...
	render() {
		return (
			<Row>
				...
				<Form id="product-form">
					...
					<Form.Row>
						<Col md={3}>
							<Form.Group>
								<img src={this.state.img1} alt="Image 1" />
								<Form.Group>
						...
						<Col md={3}>
							<Form.Group>
								<img src={this.state.img2} alt="Image 2" />
								<Form.Group>
						...
						<Col md={3}>
							<Form.Group>
								<img src={this.state.img3} alt="Image 3" />
								<Form.Group>
						...
						<Col md={3}>
							<Form.Group>
								<img src={this.state.img4} alt="Image 1" />
								<Form.Group>
			...
			//                 class="form-control"
			//                 id="electricity_charge"
			//                 placeholder="electricity_charge"
			//             />
			//         </div>
...
export default withCookies(EditUserProperty);
