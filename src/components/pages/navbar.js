                        ...
                        <ul class="navbar-nav">
                            <li class="nav-item">
                                <a class="nav-link active" href="/">
                                    <i class="d-none fas fa-home"></i>Home
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{#}">
                                    <i class="d-none fas fa-info"></i>About
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{#}">
                                    <i class="d-none fas fa-shopping-cart"></i>Rent
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="./contactus">
                                    <i class="d-none fas fa-comments"></i>Contact
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link " href="{#}">
                                    <i class="d-none fas fa-sign-in-alt"></i>Signin
                                </a>
                            </li>
                        </ul>
                    </div>
